...
from .controllers import streak_leaderboard_view, video_call_leaderboard_view, audio_call_leaderboard_view

urlpatterns = [
    path('streaks/', streak_leaderboard_view),
    path('video-call-time/', video_call_leaderboard_view),
    path('audio_call-time/', audio_call_leaderboard_view),
