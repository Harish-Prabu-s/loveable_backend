            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <div className="mt-2 text-xs flex items-center gap-2">
                  <ShieldCheck className={`w-4 h-4 ${valid ? 'text-emerald-500' : 'text-muted-foreground'}`} />
              ...
              <button
                ...
                className={`w-full font-bold py-3 rounded-xl active:scale-95 transition flex items-center justify-center gap-2 ${
                  valid && !loading ? 'bg-primary text-white' : 'bg-muted text-muted-foreground cursor-not-allowed'
                }`}
              >
