...
export default function AudioCallLeaderboardScreen() {
    ...
    const loadData = async () => {
        try {
            const results = await gamificationApi.getAudioCallLeaderboard();
            setData(results);
        } catch (e) {
            console.error(e);
        } finally {
        ...
        return (
            ...
            >
                ...
                <View style={styles.scoreContainer}>
                    ...
                    <Text style={[styles.scoreText, { color: '#10B981' }]}>{formatDuration(item.total_duration)}</Text>
                </View>
            </TouchableOpacity>
        );
    };
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
            <View style={[styles.header, { borderBottomColor: colors.border }]}>
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>Audio Call Ranking</Text>
                <View style={{ width: 40 }} />
            </View>
...
const styles = StyleSheet.create({
    ...
    scoreContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(16, 185, 129, 0.1)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, gap: 4 },
