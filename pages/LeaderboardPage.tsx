...
const LEAGUES: { tier: LeagueTier; minPoints: number; color: string; icon: React.ReactNode }[] = [
  { tier: 'Master', minPoints: 50000, color: 'text-purple-500', icon: <Crown size={24} color="#a855f7" /> },
  { tier: 'Diamond', minPoints: 25000, color: 'text-blue-400', icon: <Star size={24} color="#60a5fa" /> },
  { tier: 'Platinum', minPoints: 10000, color: 'text-cyan-400', icon: <Trophy size={24} color="#22d3ee" /> },
  { tier: 'Gold', minPoints: 5000, color: 'text-yellow-400', icon: <Medal size={24} color="#facc15" /> },
  { tier: 'Silver', minPoints: 1000, color: 'text-gray-400', icon: <Medal size={24} color="#9ca3af" /> },
  { tier: 'Bronze', minPoints: 0, color: 'text-orange-700', icon: <Medal size={24} color="#c2410c" /> },
];
